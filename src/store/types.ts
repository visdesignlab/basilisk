...
type MouseDownEvent = [number, 'mousedown', [number, number]];
type MouseUpEvent = [number, 'mouseup', [number, number]];
type MouseMoveEvent = [number, 'mousemove', [number, number]];
type ResizeEvent = [number, 'resize', [number, number]];
type ScrollEvent = [number, 'scroll', [number, number]];
...
export type MouseEventType = MouseMoveEvent | MouseDownEvent | MouseUpEvent;
